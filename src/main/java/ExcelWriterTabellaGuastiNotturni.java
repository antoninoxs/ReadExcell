...
public class ExcelWriterTabellaGuastiNotturni {
    ...
    private void writeIntestazioneExcellGuastiNotturni(String dateToSearch, String nextDate, CellStyle cs) {
...
// code to get the style for the cell goes here
        ...
        writeIntestazioneExcellGuastiNotturni(precDate, dateToSearch, cs3);

        writeListToExcelGuastiNotturni(listTreniNoImpianto500, listSegnalazioniSO, listSegnalazioniPDB, cs2, cs2l);
        writeListToExcelGuastiNotturni(listTreniNoImpianto1000, listSegnalazioniSO, listSegnalazioniPDB, cs2, cs2l);
        writeListToExcelGuastiNotturni(listTreniNoImpianto700, listSegnalazioniSO, listSegnalazioniPDB, cs2, cs2l);
        writeListToExcelGuastiNotturni(listTreniNoImpianto600, listSegnalazioniSO, listSegnalazioniPDB, cs2, cs2l);
...
//        sheet.setColumnWidth(6, 70 * 256);
    ...
    private void writeListToExcelGuastiNotturni(ArrayList<Treno>[] arrayTreno, ArrayList<SegnalazioniSO> listSegnalazioniSO, ArrayList<SegnalazioniPDB> listSegnalazioniPDB, CellStyle cs, CellStyle csl) {
