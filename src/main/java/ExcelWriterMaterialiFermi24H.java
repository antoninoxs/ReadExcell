...
public class ExcelWriterMaterialiFermi24H {
    ...
    public void write(ArrayList<Integer> list500, ArrayList<Integer> list1000, ArrayList<Integer> list700, ArrayList<Integer> list600, String dateToSearch) throws IOException, ParseException {
