...
public class ExcelReaderIVU {
    ...
    public void ExcelREaderIVU(String path, Date searchDate) throws IOException, InvalidFormatException {
...
//        System.out.println("ESTRAZIONE: " + numeroMateriale);
    ...
    public void materialiFuoriImpianto(){
        for (int i = 0; i < size500; i++) {
            ...
            if(sizeGiri == 1){
                StrisciaIvu tempStrisciaIvu = giriMateriale.get(0);
